...
extern void Na_RhythmPos(uintptr_t index, u8 unused, u16 angle, f32 distance);
extern void Na_SpecChange(int);
extern void Na_MDPlayerPos(u16 angle, f32 distance, u16 b, u16 c, uintptr_t id);
...
extern u8 Na_RoomIncectPos(uintptr_t insectID, u8 index, u16 angle, f32 distance);
extern void Na_FurnitureInstPos(uintptr_t id, u16 angle, f32 distance);
